    ...
    <div class="px-4 sm:px-6 lg:px-8">
        <div class="sm:flex sm:items-center">
            <div class="sm:flex-auto">
                ...
                <p class="mt-2 text-sm text-gray-700">Lista de todos los productos del sistema con sus detalles y acciones disponibles.</p>
            </div>
                    ...
                    <table class="min-w-full divide-y divide-gray-300">
                        ...
                        <tbody class="divide-y divide-gray-200">
                            @forelse ($productos as $producto)
                                <tr>
                                    <td class="py-4 pr-3 pl-4 text-sm font-medium whitespace-nowrap text-gray-900 sm:pl-0">{{ $producto->id }}</td>
                                    <td class="px-3 py-4 text-sm whitespace-nowrap text-gray-500">{{ $producto->nombre }}</td>
                                    <td class="px-3 py-4 text-sm text-gray-500">{{ Str::limit($producto->descripcion, 50) }}</td>
                                    <td class="px-3 py-4 text-sm whitespace-nowrap text-gray-500">Q. {{ number_format($producto->precio, 2) }}</td>
                                    <td class="relative py-4 pr-4 pl-3 text-right text-sm font-medium whitespace-nowrap sm:pr-0">
                                        <button wire:click="edit({{ $producto->id }})" class="text-indigo-600 hover:text-indigo-900 mr-3">
                                            Editar<span class="sr-only">, {{ $producto->nombre }}</span>
                                        </button>
                                        <button wire:click="confirmDelete({{ $producto->id }})" class="text-red-600 hover:text-red-900">
                            ...
                            @empty
                                <tr>
                                    <td colspan="5" class="py-4 pl-4 pr-3 text-sm font-medium text-gray-900 sm:pl-0 text-center">
                        ...
                        <div>
                            ...
                            <div class="mt-3 text-center sm:mt-5">
                                ...
                                <div class="mt-2 space-y-4">
                                    <div>
                                        <label for="nombre" class="block text-sm/6 font-medium text-gray-900">Nombre del Producto</label>
                                        <div class="mt-2">
                                    ...
                                    <div>
                                        ...
                                        <div class="mt-2">
                                            <textarea wire:model="descripcion" id="descripcion" rows="3" class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6"></textarea>
                                        </div>
                                    ...
                                    <div>
                                        ...
                                        <div class="mt-2 relative rounded-md shadow-sm">
                                            ...
                                            <input wire:model="precio" id="precio" type="number" step="0.01" min="0" class="block w-full rounded-md bg-white px-3 py-1.5 pl-7 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6">
                                        </div>
